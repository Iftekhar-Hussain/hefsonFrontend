...
const Customer = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (!hasError) {
      ...
      if(userRole !== 4) {
        dispatch(updateCustomer(currentId, nonDriverUpdate));
      }
    }
  ...
  const editHandler = async (e, ID) => {
    ...
    console.log(("driverToUpdate => ", driverToUpdate));
    ...
    setCustomerUpdateData({
      ...
      licenseNo: driverToUpdate?.licenseNo,
      licenseExp: driverToUpdate?.licenseExp,
      issuedState: driverToUpdate?.issuedState,
    });
  };
