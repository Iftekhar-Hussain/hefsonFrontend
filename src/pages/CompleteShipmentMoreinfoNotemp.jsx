...
const CompleteShipmentMoreinfoNotemp = () => {
  const { id } = useParams();
      ...
      <div className="container-fluid">
        {loginToken ? (
          <HeaderComponentShareLink
            titleProp={titleProp}
            searching={false}
            temp={"CompleteShipmentMoreinfoNotemp"}
          />
        ) : (
          ...
          <div className="row mb-5 shipmentInfo mx-sm-3 mx-0">
            <div className="col-lg-8">
              <div className="row dataBox">
                ...
                <div className="col-lg-4 centerMid align-items-end  mt-3 mt-lg-0">
...
export default CompleteShipmentMoreinfoNotemp;
GoogleApiWrapper({
  apiKey: process.env.REACT_APP_MAP_API,
})(CompleteShipmentMoreinfoNotemp);
