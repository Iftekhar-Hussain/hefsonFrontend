...
import ShipmentMapComplete from "../components/ShipmentMapComplete/ShipmentMapComplete";
...
const CompleteShipmentMoreinfo = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        let lastItem = data?.data?.historyData.pop();
        shipmentlat = lastItem?.Lat;
        shipmentLng = lastItem?.Lon;
        lastTemp = lastItem?.Temp1;
                        ...
                        <div className="sensorDataBox">
                          ...
                          <div className="spaceAround">
                            <div>
                              <h2 class="d-flex">
                                {
                                  shipmentData?.historyData[
                                    shipmentData?.historyData?.length - 1
                                  ]?.Bat
                                }
            ...
            <div className="col-lg-2 mt-3 mt-lg-0 centerMid align-items-start">
              <div className="temperatureBox">
                ...
                <div className="circularGraph mt-4">
                  <div className="temperature">
                    <ProgressTemp value={lastTemp.toFixed(1)} text={"Reefer"} />
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div
                      ...
                      onClick={() => {
                        return new Promise((resolve, reject) => {
                          ...
                          setMarkerLat(shipmentData?.receiver[0]?.latitude);
                          setMarkerLng(shipmentData?.receiver[0]?.longitude);
                          setMarkerTemp(
                ...
                >
                  ...
                  <div className="textcontents">
                    ...
                    shipmentData?.isShipperLoadingComplete?.longitude ? (
                      <p className="contentTexts">{loadingCompleteAddress}</p>
                    ) : (
                      <p className="contentTexts">
                        {shipmentData?.shipper[0]?.pickupAddress}
                      </p>
...
export default CompleteShipmentMoreinfo;
GoogleApiWrapper({
  apiKey: process.env.REACT_APP_MAP_API,
})(CompleteShipmentMoreinfo);
