...
const TrailersMoreInfoAdmin = () => {
  ...
  // const imageUrl =
  //   "https://hefson.s3.ca-central-1.amazonaws.com/trailer/1692611577641-Group%201000008266%201.png";
  ...
  useEffect(() => {
    ...
    toDataURL(trailerDetail?.manufactureInfo?.image, function (dataUrl) {
      ...
      {loading ? (
        ...
        <div className="container-fluid">
          <div className="row mx-sm-4 mx-0 mb-5 trailerInfoLayout">
            <div className="col-lg-7 dataBox">
              <div className="row">
...
export default TrailersMoreInfoAdmin;
