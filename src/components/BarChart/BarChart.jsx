...
const BarChart = ({ historyData, pickup, delivery, temperature }) => {
  ...
  const options = {
    ...
    series: [
      {
        type: "column", // Set the type to "column" for a bar chart
        name: "Temperature",
      ...
      },
      {
        ...
        states: {
          hover: {
            borderWidth: 3, // Increase the value to your desired line width
            borderColor: "black", // Replace 'black' with your desired color
          },
        },
      },
    ],
