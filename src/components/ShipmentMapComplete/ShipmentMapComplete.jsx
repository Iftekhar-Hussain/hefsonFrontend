        ...
        icon={{
          url: `data:image/svg+xml;utf-8,
            <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 24 24">
              ...
              <text x="50%" y="50%" text-anchor="middle" fill="white" font-size="7px" font-weight="bold" dy=".3em">${lastTemp.toFixed(1)}F</text>
            </svg>`,
...
export default ShipmentMapComplete;
