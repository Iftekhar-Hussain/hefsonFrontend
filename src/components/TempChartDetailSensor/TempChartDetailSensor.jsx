...
const TempChartDetailSensor = ({
  ...
  const options = {
    ...
    rangeSelector: {
      enabled: true, //hide all button when false
      inputEnabled: true, //hide only date range when false
      buttonTheme: {
        visibility: "visible", // Hide the default buttons
      },
      labelStyle: {
...
export default TempChartDetailSensor;
